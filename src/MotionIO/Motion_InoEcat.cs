...
namespace MotionIO
{
    public class Motion_InoEcat : Motion
    {
        ...
        public Motion_InoEcat(int cardIndex, string name, int minAxisNo, int maxAxisNo)
        ...
        public override bool Init()
        {
            try
            {
                ...
                LogInfo("初始化汇川EtherCAT运动卡...");
                
                _initialized = true;
                LogInfo("汇川EtherCAT运动卡初始化成功");
                return true;
            }
        ...
        public override bool DeInit()
        {
            try
            {
                ...
                LogInfo("关闭汇川EtherCAT运动卡...");
                
                _initialized = false;
                LogInfo("汇川EtherCAT运动卡已关闭");
                return true;
            }
            catch (DllNotFoundException ex)
            {
